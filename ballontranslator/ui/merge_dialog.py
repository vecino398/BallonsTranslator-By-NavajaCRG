...
class MergeDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.specific_groups_edit.setPlaceholderText(self.tr("One group per line, labels separated by comma\ne.g.:\nballoon,balloon2\nqipao,qipao2"))
        ...
        self.allow_negative_gap = QCheckBox(self.tr("Allow negative gap (allow overlapping boxes)"))
        ...
        self.radio_output_rectangle = QRadioButton(self.tr("Merge as horizontal rectangle"))
